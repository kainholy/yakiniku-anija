    ...
    <section className={base + '__recruitInfo'} id="recruit-info">
      <div className={base + '__container'}>
        ...
        <div className={base + '__content'}>
          <p className={base + '__name c-recruit-recruit-info-name'}>
            ホールスタッフ
          </p>
          <p
            className={
              base + '__description c-recruit-recruit-info-description'
            }
          >
            お客様とのコミュニケーションや気遣いが好きな方
            接客サービスはお客様の笑顔が最大のやりがいです。
            <br />
            ...
            <tbody className={base + '__tbody'}>
              {hole.map((item, index) => (
                <tr key={index} className={base + '__tr'}>
                  <th className={base + '__th c-recruit-recruit-info-title'}>
                    {item.title}
                  </th>
                  <td className={base + '__td c-recruit-recruit-info-text'}>
                    {item.text}
                  </td>
                </tr>
              ))}
