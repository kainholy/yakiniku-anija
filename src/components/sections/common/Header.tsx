        ...
        <nav className={base + '__nav pc'}>
          <ul className={base + '__list'}>
            <li className={base + '__item'}>
              <Link href="/" className={base + '__link c-header-link bk'}>
                トップ
              </Link>
            </li>
            <li className={base + '__item'}>
              <Link
                href="/concept"
                className={base + '__link c-header-link bk'}
              >
                兄者の思い
              </Link>
            </li>
            <li className={base + '__item'}>
              <Link href="/menu" className={base + '__link c-header-link bk'}>
                お品書き
              </Link>
            </li>
            <li className={base + '__item'}>
              <Link href="/news" className={base + '__link c-header-link bk'}>
                お知らせ
              </Link>
            </li>
            <li className={base + '__item'}>
      ...
      <div className={base + '__detail pc'}>
        <ul className={base + '__detail__list'}>
          <li className={base + '__detail__item'}>
            <p className={base + '__detail__text c-header-detail-text bk'}>
              11時~15時, 17時~23時 不定休
            </p>
          </li>
          <li className={base + '__detail__item'}>
            <Link
              href="https://www.google.com/maps?ll=35.761206,139.82669&z=13&t=m&hl=ja&gl=JP&mapclient=embed&cid=13721843411329241504"
              target="_blank"
              className={base + '__detail__map__link'}
            >
              ...
              <p className={base + '__detail__text c-header-detail-text bk'}>
                東京都足立区綾瀬2丁目24-11 ホワイトハウス2F
              </p>
            </Link>
          </li>
          <li className={base + '__detail__item'}>
            <Link
              href="https://www.instagram.com/yakiniku_anija315/"
              target="_blank"
              className={base + '__detail__instagram__link'}
            >
        ...
        <nav className={base + '__ham__nav'}>
          <ul className={base + '__ham__list'}>
            <li className={base + '__ham__item'}>
              <Link href="/" className={base + '__ham__link c-header-link bk'}>
                トップ
              </Link>
            </li>
            <li className={base + '__ham__item'}>
              <Link
                href="/concept"
                className={base + '__ham__link c-header-link bk'}
              >
                兄者の思い
              </Link>
            </li>
          ...
          <div className={base + '__ham__detail'}>
            <ul className={base + '__ham__detail__list'}>
              ...
              <li className={base + '__detail__item'}>
                <Link
                  href="https://lin.ee/67Bt7wk"
                  target="_blank"
                  className={base + '__detail__instagram__link'}
                >
                  <p
                    className={
                      base + '__ham__detail__text c-header-detail-text bk'
                    }
                  >
                    ↗️ LINE追加はこちらから
                  </p>
